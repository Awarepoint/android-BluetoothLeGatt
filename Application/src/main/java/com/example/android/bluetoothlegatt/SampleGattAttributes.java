...
public class SampleGattAttributes {
    ...
    public static String NEW_ALERT_CHAR_UUID = "00002a46-0000-1000-8000-00805f9b34fb";
    ...
    static {
        ...
        attributes.put(ALERT_NOTIFICATION_SERVICE_UUID, "Alert Notification Service");
        attributes.put(NEW_ALERT_CHAR_UUID, "New Alert");
    }
